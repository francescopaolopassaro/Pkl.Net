...
A modern, type-safe configuration management library for .NET, bringing the power of Apple's **Pkl** configuration language to the C# ecosystem C#” with **zero external dependencies**.
